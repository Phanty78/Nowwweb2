  ...
  return (
    <div className="bg-dark-blue flex items-center justify-center relative py-[87px] px-[29px]">
      ...
      <div className="flex flex-col gap-4 justify-center items-center z-10">
        <h3 className="text-turquoise font-montserrat font-extrabold text-2xl lg:text-3xl text-center">
          UN PROJET ? UNE QUESTION ?
        </h3>
        <h4 className="text-white font-pt-serif italic text-lg lg:text-2xl text-center">
          Plus rapide qu&apos;une bouteille à la mer
        </h4>
        <ButtonLink
          title={capitalyzeString('contactez-nous')}
