        ...
        <main className="flex w-full flex-col items-center justify-center  ">
            ...
            <section className=" bg-light-grey w-full lg:p-[90px]">
                <div className="flex flex-col items-center justify-center gap-4 px-4 py-6 container mx-auto">
                    ...
                    <p className="font-montserrat text-sm lg:text-base text-center text-dark-blue">Experts du web, nous répondons aux <strong>problématiques de nos clients depuis plus de 10 ans.</strong> Et comme chaque besoin est unique, nous proposons des <strong>solutions personnalisées et adaptées</strong> à chaque nouveau projet. De la conception à la réalisation technique, notre équipe vous accompagne tout au long du processus de création pour obtenir le meilleur retour que l&apos;on puisse avoir : <strong>Nice Work Bro&apos; !</strong></p>
                    <ButtonLink title={capitalyzeString("Découvrir l'agence")} href={routes.contact} />
                </div>
            </section>
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-center gap-4 w-full">
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center">
                                <h4 className="text-white text-center font-montserrat font-bold text-3xl">{capitalyzeString("Hôtel Mirabeau")}</h4>
                                <p className="text-white text-center italic font-pt-serif text-xl">Site vitrine</p>
                            </div>
                        </Link>
                        <Link 
                            href="" 
                        ...
                        >
                            ...
                            />
                            <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center">
                                <h4 className="text-white text-center font-montserrat font-bold text-3xl">{capitalyzeString("Galerie Nea")}</h4>
                                <p className="text-white text-center italic font-pt-serif text-xl">Site e-commerce</p>
                            </div>
                        </Link>
                    </div>
                    <ButtonLink title={capitalyzeString("Découvrir plus de réalisations")} href={routes.contact} />
                </div>
            </section>
        </main>
    )
